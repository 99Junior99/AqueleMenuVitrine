                    ...
                    <div className="pratos">
                        <div className='prato'>
                            ...
                            <div className="text">
                                ...
                                <span className="desc">um pote de assaí com banana</span>
                        ...
                        <div className='prato'>
                            <img src={bife} alt="" />
                            <div className="text">
                                <h2 className="title">Bife</h2>
                                <span className="desc">um prato de bife com fritas</span>
